    ...
    if($handle){
        while(($fl = readdir($handle)) !== false){
            ...
            if(is_dir($temp) && $fl!='.' && $fl != '..'){
                ...
                if($fl!='.' && $fl != '..' && (substr($fl,-3)=="php" || substr($fl,-3)=="bas") && substr($fl,-8)!="conn.php" && substr($fl,-9)!="conn2.php"){
                    checkmm(gl($temp));
                }
            }
        }
